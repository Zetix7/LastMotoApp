...
public class XmlReader : IXmlReader
{
    ...
    private readonly IRepository<DataAccess.Data.Entities.Car> _carRepository;
    private readonly IRepository<DataAccess.Data.Entities.Manufacturer> _manufacturerRepository;

    public XmlReader(ICsvReader csvReader, IRepository<DataAccess.Data.Entities.Car> carRepository, IRepository<DataAccess.Data.Entities.Manufacturer> manufacturerRepository)
    {
    ...
    public void CreateCarsXmlFileFromCsvFile(string fileName)
    {
        ...
        xml.Add(xmlCars);
        xml.Save($"{IComponentHelper.DefaultPath}cars.xml");
    ...
    public void CreateManufacturersXmlFileFromCsvFile(string fileName)
    {
        ...
        xml.Save($"{IComponentHelper.DefaultPath}manufacturers.xml");
    ...
    {
        var manufacturers = _csvReader.ProcessManufacturers($"{IComponentHelper.DefaultPath}manufacturers.csv");
        var cars = _csvReader.ProcessCars($"{IComponentHelper.DefaultPath}fuel.csv");
        ...
        document.Save($"{IComponentHelper.DefaultPath}specificManufacturersCars.xml");
